...
typedef void (*rtl8125_fw_write_t)(struct rtl8125_private * const, const u16, const u16);
typedef u32 (*rtl8125_fw_read_t)(const struct rtl8125_private *const, const u16);
